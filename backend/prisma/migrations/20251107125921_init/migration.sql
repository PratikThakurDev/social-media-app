-- CreateEnum
CREATE TYPE "PostType" AS ENUM ('POST', 'THREAD', 'PROJECT', 'TIP', 'QUESTION');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('NEW_FOLLOWER', 'POST_LIKE', 'POST_DISLIKE', 'POST_COMMENT', 'NEW_MESSAGE');
